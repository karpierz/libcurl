...
def main(argv=sys.argv[1:]):
    ...
    url: str = argv[0] if len(argv) >= 1 else "rtsp://example.com/"
    ...
    with curl_guard(False, curl) as guard:
        ...
        lcurl.easy_setopt(curl, lcurl.CURLOPT_RTSP_SESSION_ID, b"12345")
        lcurl.easy_setopt(curl, lcurl.CURLOPT_RTSP_REQUEST,
