...
@curl_test_decorator
def test(URL: str,
         user_login: str = "keyId:SecretKey",
         AWS_login:  str = "provider1:provider2:region:service") -> lcurl.CURLcode:

    res: lcurl.CURLcode = TEST_ERR_MAJOR_BAD

    data = (ct.c_ubyte * 9)(0x70, 0x6f, 0x73, 0x74, 0, 0x44, 0x61, 0x74, 0x61)
    ...
    with curl_guard(True, curl) as guard:
        ...
        test_setopt(curl, lcurl.CURLOPT_POSTFIELDS, data)
        test_setopt(curl, lcurl.CURLOPT_POSTFIELDSIZE, ct.sizeof(data))
